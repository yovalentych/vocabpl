...
export const metadata: Metadata = {
  ...
  description: "Умови використання сервісу Polish Vocab Studio."
};
...
export default async function TermsPage() {
  ...
  const t = locale === "uk" ? content.uk.terms : content.pl.terms;

  return (
    <InfoPageLayout
      label="Polish Vocab Studio"
      title={t.title}
      subtitle={locale === "uk" ? "Умови користування платформою" : "Warunki korzystania z platformy"}
      updated={t.updated}
      body={
