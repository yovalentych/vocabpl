...
import ClozeLanding from "./ClozeLanding";
import ClozeClassicConfig from "./ClozeClassicConfig";
import ClozeClassicPractice from "./ClozeClassicPractice";
import ClozeAIConfig from "./ClozeAIConfig";
import ClozeAIPractice from "./ClozeAIPractice";
    ...
    <div className="space-y-6">
      ...
      {mode === "landing" && (
        <>
          ...
          <ClozeLanding onSelectMode={handleSelectMode} />
        </>
      )}

      {mode === "classic-config" && (
        <ClozeClassicConfig onStart={handleClassicConfigDone} />
      )}

      {mode === "classic-practice" && classicConfig && (
        <ClozeClassicPractice
      ...
      {mode === "ai-config" && (
        <ClozeAIConfig onStart={handleAIConfigDone} />
      )}
