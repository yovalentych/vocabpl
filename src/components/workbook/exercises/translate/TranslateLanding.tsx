      ...
      <div className="rounded-3xl border border-ink/10 bg-paper/80 p-6 shadow-soft">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <div className="flex items-start gap-3 rounded-2xl border border-ink/10 bg-fog p-4">
            ...
            <div>
              <p className="text-sm font-semibold text-ink">{t.workbook.translateLandingSkill1}</p>
              <p className="mt-1 text-xs text-ink/60">
                {t.workbook.translateLandingSkill1Desc}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 rounded-2xl border border-ink/10 bg-fog p-4">
            ...
            <div>
              <p className="text-sm font-semibold text-ink">{t.workbook.translateLandingSkill2}</p>
              <p className="mt-1 text-xs text-ink/60">
                {t.workbook.translateLandingSkill2Desc}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 rounded-2xl border border-ink/10 bg-fog p-4">
            ...
            <div>
              <p className="text-sm font-semibold text-ink">{t.workbook.translateLandingSkill3}</p>
              <p className="mt-1 text-xs text-ink/60">
                {t.workbook.translateLandingSkill3Desc}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 rounded-2xl border border-ink/10 bg-fog p-4">
            ...
            <div>
              <p className="text-sm font-semibold text-ink">{t.workbook.translateLandingSkill4}</p>
              <p className="mt-1 text-xs text-ink/60">
                {t.workbook.translateLandingSkill4Desc}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-3xl border border-ink/10 bg-paper/80 p-6 shadow-soft">
          ...
          <div className="grid gap-4 sm:grid-cols-4">
            ...
            <div className="rounded-2xl border border-ink/10 bg-fog p-4 text-center">
              ...
              <div className="mt-1 text-xs text-ink/60">{t.workbook.translateLandingAvgAccuracy}</div>
            </div>
            <div className="rounded-2xl border border-ink/10 bg-fog p-4 text-center">
              <div className="text-2xl font-bold text-terracotta">{stats.totalTranslations}</div>
              <div className="mt-1 text-xs text-ink/60">{t.workbook.translateLandingStat}</div>
            </div>
            <div className="rounded-2xl border border-ink/10 bg-fog p-4 text-center">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        >
          ...
          <p className="mt-2 text-sm text-ink/60">
            {t.workbook.translateLandingClassicDesc}
          </p>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <span className="rounded-full bg-fog px-3 py-1 text-xs text-ink/70">
              {t.workbook.featureBothDirections}
            </span>
            <span className="rounded-full bg-fog px-3 py-1 text-xs text-ink/70">
        ...
        >
          ...
          <p className="mt-2 text-sm text-ink/60">
            {t.workbook.translateLandingAIDesc}
          </p>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <span className="rounded-full bg-fog px-3 py-1 text-xs text-ink/70">
              {t.workbook.featureErrorAnalysis}
            </span>
          </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-ink/70">
              {t.workbook.translateLandingTip}
            </p>
          </div>
        </div>
      </div>
