...
import MatchClassicConfig from "./MatchClassicConfig";
import MatchClassicPractice from "./MatchClassicPractice";
import MatchAIConfig from "./MatchAIConfig";
import MatchAIPractice from "./MatchAIPractice";
    ...
    <div className="space-y-6">
      ...
      {mode === "landing" && (
        <>
          ...
          <MatchLanding onSelectMode={handleSelectMode} />
        </>
      )}

      {mode === "classic-config" && (
        <MatchClassicConfig onStart={handleClassicConfigDone} />
      )}

      {mode === "classic-practice" && classicConfig && (
        <MatchClassicPractice
      ...
      {mode === "ai-config" && (
        <MatchAIConfig onStart={handleAIConfigDone} />
      )}
