  ...
  return (
    <div className="mx-auto max-w-7xl space-y-8 p-6 sm:p-8">
      ...
      <nav className="flex items-center gap-2 text-sm">
        <Link href="/academy" className="flex items-center gap-1 text-ink/60 transition-colors hover:text-moss">
          <House size={16} weight="fill" />
          <span>{locale === 'uk' ? 'Академія' : 'Akademia'}</span>
        </Link>
        <span className="text-ink/30">/</span>
        <Link href="/academy?tab=classes" className="flex items-center gap-1 text-ink/60 transition-colors hover:text-moss">
